#!/usr/bin/env bash
# install.sh: installs wp-theme-code-audit skill into a Claude config dir
#
# Usage:
...
SKILL_NAME="wp-theme-code-audit"
...
echo ""
echo "Try it:"
echo "  \"Audit this theme for security issues.\""
echo "  \"Is this theme safe to install on production?\""
echo "  \"Review the example-theme theme from wp.org, full audit.\""
echo "  \"Review this child theme against its parent.\""
echo ""
