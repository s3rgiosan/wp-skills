#!/usr/bin/env bash
# install.sh — installs wp-migration-playbook skill into a Claude config dir
#
# Usage:
...
echo ""
echo "Try it:"
echo "  \"Plan a WordPress migration from a Laravel app — what's the shape?\""
echo "  \"How do I migrate 100K posts from WP multisite to a standalone install?\""
echo "  \"Migration deleted attachments by mistake — how do I recover without downtime?\""
echo ""
